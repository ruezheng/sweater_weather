...
RSpec.describe RoadTrip do
  ...
  #   road_trip = RoadTrip.new('salt lake city, co', 'new york, ny', '33', weather_at_eta)
  ...
  describe '::format_city_and_state' do
    it 'formats the origin and destination' do
      expect(RoadTrip.format_city_and_state('salt lake city, co')).to eq('Salt Lake City, CO')
    end
  end
